Sub GenererSommaire()
    ...
    sommaire.Cells(1, 4).Value = "Telephone"
    ...
    sommaire.Cells(1, 5).Value = "Afficher Détails"
    sommaire.Cells(1, 6).Value = "Statut"
    ...
    For i = startTour To endTour
        ...
        If Not ws Is Nothing Then
            ...
            sommaire.Cells(ligne, 4).Value = ws.Cells(4, 5).Value
            ...
            If ws.Cells(4, 6).Value = "Oui" And ws.Cells(4, 7).Value = "Oui" And ws.Cells(4, 8).Value = "Oui" And ws.Cells(4, 9).Value = "Oui" Then
                sommaire.Cells(ligne, 6).Value = "Valide"
                sommaire.Cells(ligne, 6).Interior.Color = RGB(0, 255, 0) ' Vert
            Else
                sommaire.Cells(ligne, 6).Value = "Non Valide"
                sommaire.Cells(ligne, 6).Interior.Color = RGB(255, 0, 0) ' Rouge
            End If

            ' Ajouter un hyperlien sur la ligne correspondante
            sommaire.Hyperlinks.Add Anchor:=sommaire.Cells(ligne, 5), _
